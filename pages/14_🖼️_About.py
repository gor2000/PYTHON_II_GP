...
st.markdown("This streamlit_2 app is a user-friendly interface designed by [Hamagistral](https://github.com/Hamagistral) to enhance your learning experience for the **DE Zoomcamp 2023** course offered by [DataTalksClub.](https://datatalks.club/)")
