...
## Title Tab
st.set_page_config(page_title="Group Project Python II", page_icon='👨‍🔧')

st.markdown("### 👨‍🔧 Data Engineering Zoomcamp 2023")

st.pyplot(p.dist_total((12, 6), initial_dataset, 50))
